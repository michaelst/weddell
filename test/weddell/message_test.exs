defmodule Weddell.MessageTest do
  ...
  alias Google.Pubsub.V1.{PubsubMessage, ReceivedMessage}
  ...
  describe "Message.new/1" do
    test "from a Google.Pubsub.V1.ReceivedMessage" do
      ...
      received_message = ReceivedMessage.new(%{ack_id: @ack_id, message: pubsub_message})
